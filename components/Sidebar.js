...
const Sidebar = () => {
    return (
        <div>
            <aside className="m-2 ml-auto">
                <h2> Sidebar</h2>
                <div className="">
                    <p className='block p-2 bg-black text-white'> JavaScript </p>
                    <p> Python </p>
                    <p> HTML </p>
                    <p> CSS </p>
                </div>
            ...
            <card className="w-auto grid grid-col bg-white text-center gap-4 p-4 rounded-lg ">
                ...
                <div className="flex flex-row justify-center gap-3">
                    <img src="https://picsum.photos/100/100" className="rounded-full w-20 h-20" />
